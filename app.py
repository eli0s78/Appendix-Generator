...
def main():
    ...
    with st.sidebar:
        ...
        test_content = "This is a test file.\nIf you can download this, the download mechanism is working correctly!\n\nGenerated by Appendix Generator Test"
        st.download_button(
            label="📥 Test Download (.txt)",
            data=test_content.encode('utf-8'),
            file_name="test_download.txt",
            mime="text/plain",
            help="Click to test if downloads work in your browser",
            use_container_width=True
        )
        st.caption("Click above to test downloads. File should save as 'test_download.txt'")
