...
def export_to_docx(content: str, title: str) -> bytes:
    ...
    core_properties.author = "Appendix Generator"
    core_properties.comments = "Generated by Appendix Generator AI Assistant"
    ...
    footer_run = footer_para.add_run(f"Generated by Appendix Generator\n{datetime.now().strftime('%B %d, %Y')}")
...
def export_to_pdf(content: str, title: str) -> bytes:
    ...
    footer_text = f"Generated by Appendix Generator<br/>{datetime.now().strftime('%B %d, %Y')}"
...
generator: Appendix Generator
---

"""

    full_content = f"{metadata}# {title}\n\n{content}\n\n---\n*Generated by Appendix Generator • {datetime.now().strftime('%B %d, %Y')}*"
